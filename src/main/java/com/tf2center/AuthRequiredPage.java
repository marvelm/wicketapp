...
/**
 * Redirects unauthenticated users to the login page. It also sets a
 * 'redirectTo' attribute which allows the `LoginPage` to return the user to
 * whichever page he/she was trying to access
 */
